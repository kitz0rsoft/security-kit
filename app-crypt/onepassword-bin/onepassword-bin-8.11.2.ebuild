...
HOMEPAGE="https://releases.1password.com/linux/8.11/"
SRC_URI="https://downloads.1password.com/linux/tar/stable/x86_64/1password-8.11.2.x64.tar.gz -> onepassword-bin-8.11.2.tar.gz"
